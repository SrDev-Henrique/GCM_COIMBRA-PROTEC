/** biome-ignore-all lint/a11y/noStaticElementInteractions: <not-necessary> */
/** biome-ignore-all lint/performance/noImgElement: <not-necessary> */
"use client";
    ...
    <div className="flex flex-col gap-2">
      ...
      >
        ...
        {files.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center px-4 py-3 text-center">
            ...
            <p className="font-medium text-sm">Solte suas imagens aqui</p>
            <p className="mb-1.5 text-sm">(máximo de {maxFiles} imagens)</p>
      ...
      {errors.length > 0 && (
        ...
        >
          ...
          <span>
            {errors[0] === "Some files exceed the maximum size of 5MB."
              ? "As imagens não podem ter mais de 5MB"
              : errors[0]}
          </span>
        </div>
      )}
